...
COMMON_PARAM_DESCRIPTIONS_RU = {
    'color_primary': 'Основной цвет слоя (RGB)',
    'color_secondary': 'Дополнительный цвет слоя (RGB)',
    ...
    'points': 'Количество точек отрисовки',
}
...
LAYER_PARAM_DESCRIPTIONS_RU = {
    ...
    'particles': {
        ...
        'max_lifetime': 'Макс. время жизни частицы (кадры)',
    },
    'circular_waveform': {
        'style': 'Форма круговой волны: зеркало, заливка, столбцы, энергия',
    ...
    'energy_rings': {
        'glow_enabled': 'Свечение на активных кольцах',
        'num_rings': 'Количество концентрических колец',
        'base_thickness': 'Базовая толщина линии кольца, px',
        'pulse_strength': 'Сила пульсации от звука (0–1)',
    },
    'effects': {
